...
public class TableModelSorter extends AbstractTableModel {
	/**
	 * 
	 */
	private static final long serialVersionUID = 472287368829944109L;
	...
	public TableModelSorter(TableModel tableModel) {
		this();
		setTableModel(tableModel);
	}

	public TableModelSorter(TableModel tableModel, JTableHeader tableHeader) {
		this();
	...
	private class TableModelHandler implements TableModelListener {
		public void tableChanged(TableModelEvent e) {
			...
			if (e.getFirstRow() == e.getLastRow()
				...
				fireTableChanged(new TableModelEvent(TableModelSorter.this,
													 viewIndex, viewIndex,
													 column, e.getType()));
				return;
			}
